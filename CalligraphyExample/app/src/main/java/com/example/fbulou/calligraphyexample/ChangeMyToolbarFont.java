package com.example.fbulou.calligraphyexample;
...
public class ChangeMyToolbarFont {
    ...
    public static void apply(Activity activity, AssetManager assetManager, Toolbar toolbar, String font, boolean changeTextSize) {
