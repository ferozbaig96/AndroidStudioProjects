package com.app.fbulou.fabimage;
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        if (b != null) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
                bitmapDrawable = ((BitmapDrawable) getResources().getDrawable(R.drawable.def_img, null));
            } else {
                bitmapDrawable = ((BitmapDrawable) getResources().getDrawable(R.drawable.def_img));
            }
